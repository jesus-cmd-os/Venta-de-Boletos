...
public class SistemaEstadio {
    ...
    public SistemaEstadio(int filas, int columnas) {
        ...
        this.matrizAsientos = new boolean[filas][columnas]; // false = disponible
     ...
     * @return true si la venta se realizó, false si el asiento ya estaba ocupado.
     */
    public boolean comprarBoleto(String id, String categoria, int fila, int col) {
        ...
        // MATRIZ: Marcar asiento como ocupado
        matrizAsientos[fila][col] = true;

        // COLA: Generar y encolar el reporte de venta (FIFO)
     ...
     * @return ReporteVenta o null si la cola está vacía.
     */
